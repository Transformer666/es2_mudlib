...
## 世界地圖（來源：官方天朝地圖 + es2tips blog 2014/03）

新增區域或道路時，必須參考此地圖的相對位置關係。
官方地圖圖片：sites.google.com/site/es2mud → 天朝地圖
...
【中北 — 雪亭鎮周邊】
                   野羊山(goathill)    水月村                          六甲山
 青邪宮                                        雪吟莊(xueyin)     羅城
    太乙觀  亂葬崗(graveyard)  雪亭鎮(snow)      李家村(lee)           蘆葦叢
 草原(green)                                                   三煙谷
                              老松林(oldpine)    康平(kangping)    靈雲觀
              振武軍營(zhenwu)       五堂鎮(wutang)
                                                    楓柏村    黑風山(heifeng)

【中部 — 喬陰・鯉君渡】
                        鯉君渡(lijun) ←船→ 喬陰(choyin)方向
              百花(baihua)                         老鈴
...
【南部 — 羿水流域（大河）】
              ══════════════ 羿水(河) ══════════════
                   水嵐縣          赤魈村(chixiao)      閩島
                                                   冷梅莊(lengmei)
              平陽山    文國縣    前場鎮              龍安(longan)
 京畿(jingji)    包楊嶺
              三掩(sanyen)    衛國(weiguo)/鬼洞
                        天寒村(village)              志縣
```

### 地圖要點

1. **雪亭鎮**是世界中心偏北，大部分門派在雪亭周邊的山區
2. **五堂鎮**在雪亭正南方
3. **鯉君渡**在五堂西南，是渡河的樞紐
4. **羿水**是東西向的大河，將世界分為南北兩部分
5. **冷梅莊**在羿水南岸偏東（不在雪亭附近！）
6. **龍安**在南方偏東
7. **京畿**在西南方遠處
8. **赤魈村**在河流南邊中部偏東
9. **喬陰**在鯉君渡東南方向（不是正南）
