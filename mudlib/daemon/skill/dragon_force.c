...
//
// 這是一門內功(force)心法﹐龍圖丹派懸壺濟世的根本吐納之術。內功與招式
// daemon (amazing-needle.c) 不同﹐它是被動的「力道乘數」﹕戰鬥時 COMBAT_D
...
//
// 玩家透過 map_skill("force","dragon force") 將內功對應到本心法後﹐力道
...
// 龍圖丹派弟子打坐運功時所現的內功氣象（純文字氛圍﹐無戰鬥數值）。
string *exert_msg = ({
  "$N閉目盤膝﹐緩緩運轉龍圖心經﹐周身似有一股溫醇平和之氣循經流轉。\n",
  "$N凝神吐納﹐丹田之中真氣如活水長流﹐溫養經脈﹐生生不息。\n",
  "$N默運心經﹐但覺氣息如杏林春暖﹐平和之中自有一股活人濟世的生機。\n",
});
