...
//
// 這是一門內功(force)心法﹐瑯夷派暗算取命的根本吐納之術。內功與招式
// daemon (blood_dagger.c) 不同﹐它是被動的「力道乘數」﹕戰鬥時 COMBAT_D
...
//
// 玩家透過 map_skill("force","longyeforce") 將內功對應到本心法後﹐力道
...
// 瑯夷派弟子打坐運功時所現的內功氣象（純文字氛圍﹐無戰鬥數值）。
string *exert_msg = ({
  "$N閉目盤膝﹐緩緩運轉瑯夷派內功﹐周身似有一股陰沉幽冷之氣流轉不息。\n",
  "$N凝神吐納﹐丹田之中一縷黑氣如毒蛇潛行﹐悄然滋長﹐殺機暗藏。\n",
  "$N默運內功﹐但覺氣息如暗夜潛蹤﹐幽冷之中自有一股噬人的勁力。\n",
});
