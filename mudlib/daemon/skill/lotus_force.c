...
//
// 這是一門內功(force)心法﹐白象寺以慈悲降魔的根本吐納之術。內功與招式
// daemon (rid-evil.c) 不同﹐它是被動的「力道乘數」﹕戰鬥時 COMBAT_D
...
//
// 玩家透過 map_skill("force","lotus force") 將內功對應到本心法後﹐力道
...
// 白象寺弟子打坐運功時所現的內功氣象（純文字氛圍﹐無戰鬥數值）。
string *exert_msg = ({
  "$N閉目盤膝﹐緩緩運轉蓮華心法﹐周身似有一股清淨祥和之氣流轉不息。\n",
  "$N凝神吐納﹐丹田之中一朵金蓮悄然綻放﹐慈和之意循經滋長。\n",
  "$N默運心法﹐但覺真氣如寶相莊嚴﹐祥和之中自有一股降魔的金剛之力。\n",
});
