...
//   * 結仇：莊主屬雪吟莊一脈﹐已掛 vendetta_mark="snow"——殺之會累積玩家身上
//     的 vendetta/snow﹐其後雪吟莊 NPC 一見便主動圍攻（解仇 quest 另詳）。
...
void create()
{
	...
	// 結仇標記：莊主是雪吟莊一脈﹔殺之會在玩家身上累積 vendetta/snow﹐其後
	// 雪吟莊 NPC 一見此玩家便主動圍攻（機制見 chard.c 累積、attack.c init()
	// 觸發﹐與官兵 authority 同理）。
