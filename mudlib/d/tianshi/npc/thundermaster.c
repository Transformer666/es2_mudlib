...
void create()
{
	set_name("紫衣真人", ({ "thunder priest", "ziyi", "thundermaster" }));
	set("nickname", "紫衣真人");
	set_attr("str", 20);
	set_attr("dex", 22);
	set_attr("int", 26);
	...
	set("age", 52);
	set("long",
		"這位便是天師派紫衣一脈的真人﹐一身紫青道袍隱透雷光﹐頭戴蓮\n"
		"花冠﹐手執一柄玉柄拂塵﹐面如冠玉﹐雙目炯炯如電﹐周身隱隱透著一\n"
		"股森然的雷氣。天師派紫衣一脈以雷證道﹐紫衣真人浸淫雷術數十年﹐\n"
...
int accept_apprentice(object me)
{
	...
	if( me->query_class() != "commoner" ) {
		do_chat("紫衣真人輕拂拂塵﹐說道﹕你既已入別派﹐道緣已定﹐何苦再來﹖\n");
		return 0;
	}

	// 須先在江湖上歷練過方可入道
	if( me->query_level() < 1 ) {
		do_chat("紫衣真人說道﹕你塵緣未了﹐且去歷練一番再來罷。\n");
		return 0;
	}

	// 雷術全憑靈性引動﹐靈性過低者難窺門徑（門檻甚低﹐尋常人皆可入）
	if( me->query_attr("spi") < 14 ) {
		do_chat("紫衣真人端詳了你一會﹐搖頭道﹕你靈性閉塞﹐與雷無緣﹐難學我這路道法。\n");
		return 0;
	}

	do_chat(({
		"紫衣真人上下打量了你一番﹐微微頷首。\n",
		"紫衣真人說道﹕我天師派紫衣一脈﹐以雷證道﹐你可有這份道心﹖\n",
		"紫衣真人說道﹕也罷﹐你既與雷有緣﹐我便收你入紫衣門下﹐傳你天師道法。\n",
	}));
	return 1;
}
...
{
	if( me->query_class() != "commoner" ) {
		do_chat("紫衣真人揮了揮拂塵﹐說道﹕你既已另投他派﹐去吧。\n");
		return 1;
	}
	...
	if( ::init_apprentice(me) ) {
		...
		message_vision(
			...
			this_object(), me);
		do_chat(({
			"紫衣真人說道﹕從今日起﹐你便是我天師派紫衣門下的弟子了。\n",
			"紫衣真人說道﹕道法無涯﹐你且到紫雷閣對雷參修﹐莫負了這身道法。\n",
		}));
	}
}
